...
public class ProcedureByDocGui {
    public ProcedureByDocGui(){
        openSearchWindow();
    }
    private void openSearchWindow() {
        JFrame frame = new JFrame("Search Procedures Done by a Doctor");
        ...
        JLabel title = new JLabel("Enter Doctor ID:");
        ...
        searchButton.addActionListener(e -> {
            ...
            if (!input.isEmpty()) {
                String results = HospitalGui.getProceduresByDoc(input);
